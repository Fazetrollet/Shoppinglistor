...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'VCX8roQ1heKU'),  # Ideally, keep this secure
        'HOST': os.environ.get('POSTGRES_HOST', 'ep-polished-sun-a4mhd5yl-pooler.us-east-1.aws.neon.tech'),
